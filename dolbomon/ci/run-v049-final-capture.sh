...
sleep 0.4
start_capture RecordActivity '활동 선택' '04-record-additional.png' --el senior_id 4 --ei visual_step 2 --ez visual_photos true
...
echo 'v0.4.9 final validation passed: requested layout spacing, action alignment, compact additional cards, share regression, and rendered screens.'
