...
public class SajuInput {
    ...
    public SajuInput(int year, int month, int day, int hour, Integer minute, boolean lunar, String gender) {
        this(year, month, day, hour, minute, lunar, false, gender);
    }

    public SajuInput(int year, int month, int day, int hour, Integer minute, boolean lunar, boolean lunarLeapMonth, String gender) {
        this.year = year;
        this.month = month;
        this.day = day;
        this.hour = hour;
        this.minute = minute;
        this.lunar = lunar;
        this.lunarLeapMonth = lunar && lunarLeapMonth;
        this.gender = gender;
    }
